...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Syntopia" textStyles="text-center" />
      <motion.p
      ...
      "
      >
        <span className="font-extrabold text-white">Syntopia </span>
        is the new place in the future, where you can enjoy the virtual world by
        ...
        of today, using only
        <span className="font-extrabold text-white"> VR devices </span>
